...
Public Class rpDetalleVenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisGesVen.rpDetalleVenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpDetalleVenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpDetalleVenta = New rpDetalleVenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
