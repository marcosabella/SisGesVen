...
Public Class rptComprobanteMail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisGesVen.rptComprobanteMail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptComprobanteMail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptComprobanteMail = New rptComprobanteMail()
        rpt.Site = Me.Site
        Return rpt
    End Function
