...
Public Class rpPresupuesto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisGesVen.rpPresupuesto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpPresupuesto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpPresupuesto = New rpPresupuesto()
        rpt.Site = Me.Site
        Return rpt
    End Function
