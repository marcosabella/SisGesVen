...
Public Class rptSaldosCtaCte
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SisGesVen.rptSaldosCtaCte.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaldosCtaCte
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaldosCtaCte = New rptSaldosCtaCte()
        rpt.Site = Me.Site
        Return rpt
    End Function
